...
const appleSequenceImages2 = [];
const treeSequenceImages = [];
const appleSequenceImages3 = [];
...
for (let i = 0; i <= 99; i ++) {
  appleSequenceImages2.push(`${`00${i}`.slice(-4)}.png`);
}
for (let i = 0; i <= 98; i ++) {
  treeSequenceImages.push(`${`000${i}`.slice(-3)}.jpg`);
}
for (let i = 100; i <= 180; i ++) {
  appleSequenceImages3.push(`${`00${i}`.slice(-5)}.png`);
}
...
const appleSequence2 = new ScrollSequence({
  container: '.apple-sequence2',
  scrollWith: '.apple-container2',
  images: appleSequenceImages2,
  imagesRoot: 'http://qa.enewmedia.com/jpg/',
  priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  playUntil: 'scroll-out',
  starts: 'in'
...
const appleSequence3 = new ScrollSequence({
  container: '.apple-sequence3',
  scrollWith: '.apple-container3',
  images: appleSequenceImages3,
  imagesRoot: 'http://qa.enewmedia.com/jpg/',
  priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  playUntil: 'scroll-out',
