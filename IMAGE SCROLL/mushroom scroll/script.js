...
for (let i = 0; i <= 40; i ++) {
  mushSequenceImages.push(`${`000${i}`.slice(-3)}.jpg`);
}
...
const appleSequence = new ScrollSequence({
  ...
  imagesRoot: 'http://qa.enewmedia.com/jpg/001.jpg',
...
const mushSequence = new ScrollSequence({
  container: '.mush-sequence',
  scrollWith: '.mush-container',
  images: treeSequenceImages,
  imagesRoot: 'http://qa.enewmedia.com/jpg',
  priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
