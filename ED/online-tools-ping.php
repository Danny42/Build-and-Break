...
<section class="bodypage" style="position: relative;top: -50px;">
		...
		type=submit value="trace" class="searchButton"> </form>
		</div>
		</div>	
		</div>
	<div class="bodypage">
		...
		<h1>Online Ping Tool</h1>
		</div>
			<p>Online Ping tool, used to ping your domains and find out details regarding ths Domain</p>
		 ...
		 */ main(); function main(){
		  ...
		  $whois = shell_exec("ping -c10 '" . addslashes($domain) . "'");
		  print_r($whois);
