...
$recaptchaSecret = '6LeRsDwaAAAAANTnI4Hs73PUybZ0wn-hdqKcxaph';
...
$varDefaultFROM = "info@thoughtwaresolutions.com";
$varDefaultTO = "info@thoughtwaresolutions.com";
$varDefaultReturn = "noreply@thoughtwaresolutions.com";
...
if (preg_match("/\b(?:(?:https?|ftp|http):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i", $_POST['message']))
{
	...
	if ($error_msg == NULL && $points <= $maxPoints) {
		...
		if(strpos($varURL,"thoughtware.co.za")) {
		  $varDefaultFROM = "info@thoughtware.co.za";
		  $varDefaultTO = "info@thoughtware.co.za";
		  $varDefaultReturn = "noreply@thoughtware.co.za";
		}
		if(strpos($varURL,"thoughtwaresolutions.com.au")) {
		  $varDefaultFROM = "info@thoughtwaresolutions.com.au";
		  $varDefaultTO = "info@thoughtwaresolutions.com.au";
		  $varDefaultReturn = "noreply@thoughtwaresolutions.com.au";
		}
		if(strpos($varURL,"thoughtware.co.uk")) {
		  $varDefaultFROM = "info@thoughtware.co.uk";
		  $varDefaultTO = "info@thoughtware.co.uk";
		  $varDefaultReturn = "noreply@thoughtware.co.uk";
		}
		if(strpos($varURL,"thoughtware.es")) {
		  $varDefaultFROM = "info@thoughtware.es";
		  $varDefaultTO = "info@thoughtware.es";
		  $varDefaultReturn = "noreply@thoughtware.es";
		}
		...
		*/
		...
		$mailSales->FromName = "Thoughtware Solutions Info";
		$mailSales->Subject = "Message from Thoughtware Solutions Website";  
		// Sales email - END
		...
		*/	
		...
		$msgReturn .= 'Thank you for your enquiry on the Thoughtware Solutions website ' . "\n\n";
		$msgReturn .= 'Our sales team will reach out you as soon as possible ' . "\n\n";
		$msgReturn .= 'Regards ' . "\n\n";
		$msgReturn .= 'Thoughtware Solutions' . "\n";
		...
		$mailConfirmation->Subject = "Enquiry on the Thoughtware Solutions Website";
