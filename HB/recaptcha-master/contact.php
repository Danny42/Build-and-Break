...
$recaptchaSecret = '6LfL9NoUAAAAAK8hiGIABtYaLmUW5Aslnir85w1T';
...
//$varDefaultFROM = "daniel.vandenberg@enewmedia.com";
//$varDefaultTO = "daniel.vandenberg@enewmedia.com";
$varDefaultFROM = "info@habsburggroup.com";
$varDefaultTO = "info@habsburggroup.com";
$varDefaultReturn = "noreply@habsburggroup.com";
...
if (preg_match("/\b(?:(?:https?|ftp|http):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i", $_POST['message']))
{
	...
	if ($error_msg == NULL && $points <= $maxPoints) {
		...
		if(strpos($varURL,"habsburggroup.com")) {
		  $varDefaultFROM = "info@habsburggroup.com";
		  $varDefaultTO = "info@habsburggroup.com";
		  $varDefaultReturn = "noreply@habsburggroup.com";
		}
		if(strpos($varURL,"habsburggroup.co.za")) {
		  $varDefaultFROM = "info@habsburggroup.co.za";
		  $varDefaultTO = "info@habsburggroup.co.za";
		  $varDefaultReturn = "noreply@habsburggroup.co.za";
		}
		if(strpos($varURL,"info@habsburggroup.es")) {
		  $varDefaultFROM = "info@habsburggroup.es";
		  $varDefaultTO = "info@habsburggroup.es";
		  $varDefaultReturn = "noreply@habsburggroup.es";
		}
		...
		*/
		...
		$mailSales->FromName = "Secured Enterprise Info";
		$mailSales->Subject = "Message from Habsburg Group Website";  
		// Sales email - END
		...
		*/	
		...
		$msgReturn .= 'Thank you for your enquiry on the Habsburg Group ' . "\n\n";
		$msgReturn .= 'Our sales team will reach out you as soon as possible ' . "\n\n";
		$msgReturn .= 'Regards ' . "\n\n";
		$msgReturn .= 'Habsburg Group' . "\n";
		...
		$mailConfirmation->Subject = "Enquiry on the Habsburg Group Website";
