...
$recaptchaSecret = '6LdMt9oUAAAAAGzOY9aF9QtNIj5XtrAmKWnznzoi';
...
$varDefaultFROM = "info@securedenterprise.co.za";
$varDefaultTO = "info@securedenterprise.co.za";
...
if (preg_match("/\b(?:(?:https?|ftp|http):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i", $_POST['message']))
{
	...
	if ($error_msg == NULL && $points <= $maxPoints) {
		...
		if(strpos($varURL,"securedenterprise.com.au")) {
		  $varDefaultFROM = "info@securedenterprise.com.au";
		  $varDefaultTO = "info@securedenterprise.com.au";
		  $varDefaultReturn = "noreply@securedenterprise.com.au";
		}
		if(strpos($varURL,"info@securedenterprise.co.uk")) {
		  $varDefaultFROM = "info@securedenterprise.co.uk";
		  $varDefaultTO = "info@securedenterprise.co.uk";
		  $varDefaultReturn = "noreply@securedenterprise.co.uk";
		}
		if(strpos($varURL,"info@securedenterprise.es")) {
		  $varDefaultFROM = "info@securedenterprise.es";
		  $varDefaultTO = "info@securedenterprise.es";
		...
		*/
		...
		$mailSales->Subject = "Message from Secured Enterprise Website";  
		// Sales email - END
		...
		*/	
		...
		$msgReturn .= 'Thank you for your enquiry on the Secured Enterprise ' . "\n\n";
		...
		$mailConfirmation->Subject = "Enquiry on the Secured Enterprise Website";
