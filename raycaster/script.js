...
function init() {
  for (var i = 0; i<10; i++) {
    ...
    var material = new THREE.MeshStandardMaterial({shading:THREE.FlatShading, color:0xffffff, transparent:false, opacity:1, wireframe:false});
...
function animate() {
  ...
  for (var i = 0, l = particularGruop.children.length; i<l; i++) {
    ...
    newObject.rotation.x += newObject.speedValue/50;
